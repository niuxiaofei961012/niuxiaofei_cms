...
<ul class="sidebar navbar-nav" >
	...
	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="/article/getTitlesByAdmin">
	...
	<li class="nav-item"><a class="nav-link" href="javascript:void(0)" data="/styles/settings">
