			...
			<div class="col-md-7 split min_h_500">
				...
				<c:if test="${article.channelId ==null }">
					...
					<div id="hot">
						...
						<!-- 新闻热点 -->
						搜索所用时间:${time}
						<c:forEach items="${pageInfo.content}" var="c">
							<div class="media">
							...
							<nav aria-label="...">
								<ul class="pagination">
									...
									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/search?key=${key}&page=1">首页</a>
									</li>

									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/search?key=${key}&page=${page-1>0?page-1:1}">上一页</a>
									</li>

									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/search?key=${key}&page=${page+1>pageInfo.totalPages?pageInfo.totalPages:page+1}">下一页</a>
									</li>

									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/search?key=${key}&page=${pageInfo.totalPages}">尾页</a>
									</li>
								</ul>
							</nav>
					</div>
				...
				<c:if test="${article.channelId!=null }">
					...
					<div id="article">
						<c:forEach items="${articles}" var="c">
							...
							">${c.title}
										&nbsp;&nbsp;&nbsp; <a
											href="javascript:detail(${c.id},${c.type})">跳转详细信息</a>
									</h5>
									<p class="blog_item_footer">
